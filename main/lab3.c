...
#define SAMPLE_DEVICE_NAME          "RESTAURANT 9"
...
static uint8_t raw_adv_data[] = {
        ...
        0x03, 0x03, 0xFF, 0x00,
        /* device name */
        0x0E, 0x09, 'B', 'L', 'I', '_', 'C', 'O','M', 'P', '_', 'T','E', 'S', 'T'
};
...
static const uint8_t char_3_name[]  = "Get discount";
...
static const esp_gatts_attr_db_t gatt_db[HRS_IDX_NB] =
{
   ...
   /* Characteristic Declaration */
    ...
    {{ESP_GATT_AUTO_RSP}, {ESP_UUID_LEN_16, (uint8_t *)&character_user_description, ESP_GATT_PERM_READ,
      sizeof(char_3_name), sizeof(char_3_name), (uint8_t *)char_3_name}},
